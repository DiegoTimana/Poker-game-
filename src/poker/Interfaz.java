...
public class Interfaz extends JFrame {
    ...
    public void setEntorno() {
        setVisible(true);
        setTitle("Poker Univalle Extravaganza 【﻿ｄ ｅ ｌ ｕ ｘ ｅ】");
    ...
    public void pintarInfo(Jugador jugador) {
        if (jugador.getName() == "humano") {
            ...
            if (jugador.getBalance() > 0) {
                ...
                JLabel infoPc = new JLabel("           Dinero: $" + 0);
                infoPc.setFont(new Font("SansSerif.bolditalic", Font.BOLD, 15));
                infoPc.setForeground(Color.white);
                areaPcInfo.add(infoPc);
            }
     ...
     * porque las jugadas se hacen desde otros botones. Las cartas se representan
     * graficamente mediante botones
     *
     ...
     */
    /*
     * Este metodo añade las cartas a los paneles para ser graficadas, dependiendo
     * del jugador que se le ingrese las pinta ocultas o no
     */
     ...
     */
    /*
     * Limpia todos los paneles de la interfaz, dejándolos sin ningun componente. Se
     * utiliza cuando se quiere reiniciar el juego
     */
