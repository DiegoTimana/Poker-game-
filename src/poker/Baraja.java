...
public class Baraja {
     ...
     * 
     * @param i Idica la posicion de una carta en una determinada ArrayList de
     *          cartas.
    ...
    /**
     * Método usado para repartir cartas, se toma la ultima carta de la baraja, no
     * hay que randomizar la selección porque la baraja de por sí ya está
     * randomizada.
     *
     ...
     * 
     * @param i Indica la posicion de una carta en una determinada ArrayList de
     *          cartas.
     */
